...
- **Dashboard i18n**: all dashboard subtitle strings now localized (6 new ARB keys)
...
- Removed redundant dashboard sections: notifications tile, my issues tile, repository summary list
