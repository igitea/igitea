...
class Injection {
  ...
  static late EditCommentUseCase editCommentUseCase;
  static late DeleteCommentUseCase deleteCommentUseCase;
  static late CheckIssueSubscriptionUseCase checkIssueSubscriptionUseCase;
  static late AddIssueSubscriptionUseCase addIssueSubscriptionUseCase;
  static late DeleteIssueSubscriptionUseCase deleteIssueSubscriptionUseCase;
  static late ListIssueDependenciesUseCase listIssueDependenciesUseCase;
  static late CreateIssueDependencyUseCase createIssueDependencyUseCase;
  static late RemoveIssueDependencyUseCase removeIssueDependencyUseCase;
  static late EditIssueDeadlineUseCase editIssueDeadlineUseCase;
  static late GetIssueTimelineUseCase getIssueTimelineUseCase;
  ...
  static void _assertUseCasesInitialized() {
    ...
    assert(editCommentUseCase != null);
    assert(deleteCommentUseCase != null);
    assert(checkIssueSubscriptionUseCase != null);
    assert(addIssueSubscriptionUseCase != null);
    assert(deleteIssueSubscriptionUseCase != null);
    assert(listIssueDependenciesUseCase != null);
    assert(createIssueDependencyUseCase != null);
    assert(removeIssueDependencyUseCase != null);
    assert(editIssueDeadlineUseCase != null);
    assert(getIssueTimelineUseCase != null);
  ...
  static void _initUseCases() {
    ...
    editCommentUseCase = EditCommentUseCase(repository: issueRepository);
    deleteCommentUseCase = DeleteCommentUseCase(repository: issueRepository);
    checkIssueSubscriptionUseCase = CheckIssueSubscriptionUseCase(repository: issueRepository);
    addIssueSubscriptionUseCase = AddIssueSubscriptionUseCase(repository: issueRepository);
    deleteIssueSubscriptionUseCase = DeleteIssueSubscriptionUseCase(repository: issueRepository);
    listIssueDependenciesUseCase = ListIssueDependenciesUseCase(repository: issueRepository);
    createIssueDependencyUseCase = CreateIssueDependencyUseCase(repository: issueRepository);
    removeIssueDependencyUseCase = RemoveIssueDependencyUseCase(repository: issueRepository);
    editIssueDeadlineUseCase = EditIssueDeadlineUseCase(repository: issueRepository);
    getIssueTimelineUseCase = GetIssueTimelineUseCase(repository: issueRepository);
