...
class ActionWorkflowRunsResponse {
  ...
  const ActionWorkflowRunsResponse({this.total_count, this.workflow_runs});
  factory ActionWorkflowRunsResponse.fromJson(Map<String, dynamic> json) {
    return ActionWorkflowRunsResponse(
      total_count: json['total_count'] != null
          ...
          : null,
      workflow_runs: json['workflow_runs'] != null
          ? (json['workflow_runs'] as List<dynamic>)
                .map(
                  (e) => ActionWorkflowRun.fromJson(e as Map<String, dynamic>),
                )
                .toList()
          : null,
    );
  ...
  Map<String, dynamic> toJson() {
    ...
    if (workflow_runs != null)
      map['workflow_runs'] = workflow_runs!.map((e) => e.toJson()).toList();
    return map;
  }
  ...
  @override
  String toString() =>
      'ActionWorkflowRunsResponse(total_count: $total_count, workflow_runs: $workflow_runs)';
}
