...
class ActionRunnersResponse {
  ...
  const ActionRunnersResponse({
    this.runners,
    this.total_count,
  });
  factory ActionRunnersResponse.fromJson(Map<String, dynamic> json) {
    return ActionRunnersResponse(
      runners: json['runners'] != null ? (json['runners'] as List<dynamic>).map((e) => ActionRunner.fromJson(e as Map<String, dynamic>)).toList() : null,
      total_count: json['total_count'] != null ? (json['total_count'] as num).toInt() : null,
    );
  }
  Map<String, dynamic> toJson() {
    final map = <String, dynamic>{};
    if (runners != null) map['runners'] = runners!.map((e) => e.toJson()).toList();
  ...
  @override
  String toString() => 'ActionRunnersResponse(runners: $runners, total_count: $total_count)';
}
