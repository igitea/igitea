...
class UserSettings {
  ...
  @override
  String toString() =>
      'UserSettings(description: $description, diff_view_style: $diff_view_style, full_name: $full_name, hide_activity: $hide_activity, hide_email: $hide_email, language: $language, location: $location, theme: $theme, website: $website)';
}
