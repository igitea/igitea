...
class IssueFormField {
  ...
  factory IssueFormField.fromJson(Map<String, dynamic> json) {
    return IssueFormField(
      ...
      type: json['type'] != null
          ? IssueFormFieldType.fromJson(json['type'] as Map<String, dynamic>)
          : null,
      ...
      visible: json['visible'] != null
          ? (json['visible'] as List<dynamic>)
                .map(
                  (e) =>
                      IssueFormFieldVisible.fromJson(e as Map<String, dynamic>),
                )
                .toList()
          : null,
    );
  ...
  Map<String, dynamic> toJson() {
    ...
    if (visible != null)
      map['visible'] = visible!.map((e) => e.toJson()).toList();
    return map;
  }
  ...
  @override
  String toString() =>
      'IssueFormField(attributes: $attributes, id: $id, type: $type, validations: $validations, visible: $visible)';
}
