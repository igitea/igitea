...
class StopWatch {
  ...
  factory StopWatch.fromJson(Map<String, dynamic> json) {
    return StopWatch(
      ...
      issue_index: json['issue_index'] != null
          ? (json['issue_index'] as num).toInt()
          : null,
      issue_title: json['issue_title'] != null
          ? json['issue_title'] as String
          : null,
      repo_name: json['repo_name'] != null ? json['repo_name'] as String : null,
      repo_owner_name: json['repo_owner_name'] != null
          ? json['repo_owner_name'] as String
          : null,
  ...
  @override
  String toString() =>
      'StopWatch(created: $created, duration: $duration, issue_index: $issue_index, issue_title: $issue_title, repo_name: $repo_name, repo_owner_name: $repo_owner_name, seconds: $seconds)';
}
