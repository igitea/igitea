...
class TransferRepoOption {
  ...
  factory TransferRepoOption.fromJson(Map<String, dynamic> json) {
    return TransferRepoOption(
      ...
      team_ids: json['team_ids'] != null ? (json['team_ids'] as List<dynamic>).map((e) => (e as num).toInt()).toList() : null,
    );
  }
  ...
  @override
  String toString() => 'TransferRepoOption(new_owner: $new_owner, team_ids: $team_ids)';
}
