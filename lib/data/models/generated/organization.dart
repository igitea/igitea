...
class Organization {
  ...
  @override
  String toString() =>
      'Organization(avatar_url: $avatar_url, description: $description, email: $email, full_name: $full_name, id: $id, location: $location, name: $name, repo_admin_change_team_access: $repo_admin_change_team_access, username: $username, visibility: $visibility, website: $website)';
}
