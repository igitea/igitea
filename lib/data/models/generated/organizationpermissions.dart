...
class OrganizationPermissions {
  ...
  factory OrganizationPermissions.fromJson(Map<String, dynamic> json) {
    return OrganizationPermissions(
      can_create_repository: json['can_create_repository'] != null
          ? json['can_create_repository'] as bool
          : null,
  ...
  Map<String, dynamic> toJson() {
    ...
    if (can_create_repository != null)
      map['can_create_repository'] = can_create_repository!;
  ...
  @override
  String toString() =>
      'OrganizationPermissions(can_create_repository: $can_create_repository, can_read: $can_read, can_write: $can_write, is_admin: $is_admin, is_owner: $is_owner)';
}
