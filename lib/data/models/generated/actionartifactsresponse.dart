...
class ActionArtifactsResponse {
  ...
  const ActionArtifactsResponse({this.artifacts, this.total_count});
    ...
    return ActionArtifactsResponse(
      artifacts: json['artifacts'] != null
          ? (json['artifacts'] as List<dynamic>)
                .map((e) => ActionArtifact.fromJson(e as Map<String, dynamic>))
                .toList()
          : null,
  ...
  @override
  String toString() =>
      'ActionArtifactsResponse(artifacts: $artifacts, total_count: $total_count)';
}
