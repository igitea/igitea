...
class EditTeamOption {
  ...
  @override
  String toString() => 'EditTeamOption(can_create_org_repo: $can_create_org_repo, description: $description, includes_all_repositories: $includes_all_repositories, name: $name, permission: $permission, units: $units, units_map: $units_map)';
}
