...
class CreateOrgOption {
  ...
  @override
  String toString() =>
      'CreateOrgOption(description: $description, email: $email, full_name: $full_name, location: $location, repo_admin_change_team_access: $repo_admin_change_team_access, username: $username, visibility: $visibility, website: $website)';
}
