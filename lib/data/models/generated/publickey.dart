...
class PublicKey {
  ...
  factory PublicKey.fromJson(Map<String, dynamic> json) {
    return PublicKey(
      ...
      fingerprint: json['fingerprint'] != null ? json['fingerprint'] as String : null,
  ...
  bool operator ==(Object other) =>
      ...
      other is PublicKey &&
          ...
          user == other.user;
  @override
  int get hashCode => Object.hash(created_at, fingerprint, id, key, key_type, last_used_at, read_only, title, url, user);
  @override
  String toString() => 'PublicKey(created_at: $created_at, fingerprint: $fingerprint, id: $id, key: $key, key_type: $key_type, last_used_at: $last_used_at, read_only: $read_only, title: $title, url: $url, user: $user)';
}
