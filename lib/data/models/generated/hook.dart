...
class Hook {
  ...
  @override
  int get hashCode => Object.hash(active, authorization_header, branch_filter, config, created_at, events, id, type, updated_at);
  @override
  String toString() => 'Hook(active: $active, authorization_header: $authorization_header, branch_filter: $branch_filter, config: $config, created_at: $created_at, events: $events, id: $id, type: $type, updated_at: $updated_at)';
}
