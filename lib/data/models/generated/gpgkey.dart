...
class GPGKey {
  ...
  factory GPGKey.fromJson(Map<String, dynamic> json) {
    return GPGKey(
      can_certify: json['can_certify'] != null
          ? json['can_certify'] as bool
          : null,
      can_encrypt_comms: json['can_encrypt_comms'] != null
          ? json['can_encrypt_comms'] as bool
          : null,
      can_encrypt_storage: json['can_encrypt_storage'] != null
          ? json['can_encrypt_storage'] as bool
          : null,
      ...
      emails: json['emails'] != null
          ? (json['emails'] as List<dynamic>)
                .map((e) => GPGKeyEmail.fromJson(e as Map<String, dynamic>))
                .toList()
          : null,
      ...
      primary_key_id: json['primary_key_id'] != null
          ? json['primary_key_id'] as String
          : null,
      public_key: json['public_key'] != null
          ? json['public_key'] as String
          : null,
      subkeys: json['subkeys'] != null
          ? (json['subkeys'] as List<dynamic>)
  ...
  Map<String, dynamic> toJson() {
    ...
    if (can_encrypt_comms != null)
      map['can_encrypt_comms'] = can_encrypt_comms!;
    if (can_encrypt_storage != null)
      map['can_encrypt_storage'] = can_encrypt_storage!;
    ...
    if (subkeys != null)
      map['subkeys'] = subkeys!.map((e) => e.toJson()).toList();
  ...
  @override
  String toString() =>
      'GPGKey(can_certify: $can_certify, can_encrypt_comms: $can_encrypt_comms, can_encrypt_storage: $can_encrypt_storage, can_sign: $can_sign, created_at: $created_at, emails: $emails, expires_at: $expires_at, id: $id, key_id: $key_id, primary_key_id: $primary_key_id, public_key: $public_key, subkeys: $subkeys, verified: $verified)';
}
