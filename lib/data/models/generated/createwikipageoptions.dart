...
class CreateWikiPageOptions {
  ...
  final String? title;
  const CreateWikiPageOptions({this.content_base64, this.message, this.title});
  ...
  @override
  String toString() =>
      'CreateWikiPageOptions(content_base64: $content_base64, message: $message, title: $title)';
}
