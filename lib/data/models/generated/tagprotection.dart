...
class TagProtection {
  ...
  factory TagProtection.fromJson(Map<String, dynamic> json) {
    return TagProtection(
      ...
      name_pattern: json['name_pattern'] != null ? json['name_pattern'] as String : null,
      updated_at: json['updated_at'] != null ? DateTime.parse(json['updated_at'] as String) : null,
      whitelist_teams: json['whitelist_teams'] != null ? (json['whitelist_teams'] as List<dynamic>).cast<String>() : null,
      whitelist_usernames: json['whitelist_usernames'] != null ? (json['whitelist_usernames'] as List<dynamic>).cast<String>() : null,
    );
  }
  Map<String, dynamic> toJson() {
    ...
    if (whitelist_usernames != null) map['whitelist_usernames'] = whitelist_usernames!;
    return map;
  }
  @override
  ...
  @override
  int get hashCode => Object.hash(created_at, id, name_pattern, updated_at, whitelist_teams, whitelist_usernames);
  @override
  String toString() => 'TagProtection(created_at: $created_at, id: $id, name_pattern: $name_pattern, updated_at: $updated_at, whitelist_teams: $whitelist_teams, whitelist_usernames: $whitelist_usernames)';
}
