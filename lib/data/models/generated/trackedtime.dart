...
class TrackedTime {
  ...
  factory TrackedTime.fromJson(Map<String, dynamic> json) {
    return TrackedTime(
      ...
      issue_id: json['issue_id'] != null ? (json['issue_id'] as num).toInt() : null,
  ...
  @override
  int get hashCode => Object.hash(created, id, issue, issue_id, time, user_id, user_name);
  @override
  String toString() => 'TrackedTime(created: $created, id: $id, issue: $issue, issue_id: $issue_id, time: $time, user_id: $user_id, user_name: $user_name)';
}
