...
class User {
  ...
  factory User.fromJson(Map<String, dynamic> json) {
    return User(
      ...
      source_id: json['source_id'] != null
          ...
          : null,
      starred_repos_count: json['starred_repos_count'] != null
          ? (json['starred_repos_count'] as num).toInt()
          : null,
  ...
  Map<String, dynamic> toJson() {
    ...
    if (starred_repos_count != null)
      map['starred_repos_count'] = starred_repos_count!;
  ...
  @override
  String toString() =>
      'User(active: $active, avatar_url: $avatar_url, created: $created, description: $description, email: $email, followers_count: $followers_count, following_count: $following_count, full_name: $full_name, html_url: $html_url, id: $id, is_admin: $is_admin, language: $language, last_login: $last_login, location: $location, login: $login, login_name: $login_name, prohibit_login: $prohibit_login, restricted: $restricted, source_id: $source_id, starred_repos_count: $starred_repos_count, visibility: $visibility, website: $website)';
}
