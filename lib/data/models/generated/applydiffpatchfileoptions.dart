...
class ApplyDiffPatchFileOptions {
  ...
  final bool? signoff;
  const ApplyDiffPatchFileOptions({
    this.author,
    this.branch,
    this.committer,
    this.content,
  ...
  factory ApplyDiffPatchFileOptions.fromJson(Map<String, dynamic> json) {
  ...
  bool operator ==(Object other) =>
      ...
      other is ApplyDiffPatchFileOptions &&
          author == other.author &&
          branch == other.branch &&
  ...
  @override
  String toString() => 'ApplyDiffPatchFileOptions(author: $author, branch: $branch, committer: $committer, content: $content, dates: $dates, message: $message, new_branch: $new_branch, signoff: $signoff)';
}
