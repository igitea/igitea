...
class ApplyDiffPatchFileOptions {
  ...
  @override
  String toString() =>
      'ApplyDiffPatchFileOptions(author: $author, branch: $branch, committer: $committer, content: $content, dates: $dates, message: $message, new_branch: $new_branch, signoff: $signoff)';
}
