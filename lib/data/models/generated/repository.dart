...
class Repository {
  ...
  factory Repository.fromJson(Map<String, dynamic> json) {
    return Repository(
      allow_fast_forward_only_merge:
          json['allow_fast_forward_only_merge'] != null
          ? json['allow_fast_forward_only_merge'] as bool
          : null,
      allow_manual_merge: json['allow_manual_merge'] != null
          ? json['allow_manual_merge'] as bool
          : null,
      allow_merge_commits: json['allow_merge_commits'] != null
          ? json['allow_merge_commits'] as bool
          : null,
      allow_rebase: json['allow_rebase'] != null
          ? json['allow_rebase'] as bool
          : null,
      allow_rebase_explicit: json['allow_rebase_explicit'] != null
          ? json['allow_rebase_explicit'] as bool
          : null,
      allow_rebase_update: json['allow_rebase_update'] != null
          ? json['allow_rebase_update'] as bool
          : null,
      allow_squash_merge: json['allow_squash_merge'] != null
      ...
      archived_at: json['archived_at'] != null
          ...
          : null,
      autodetect_manual_merge: json['autodetect_manual_merge'] != null
          ? json['autodetect_manual_merge'] as bool
          : null,
      ...
      default_allow_maintainer_edit:
          json['default_allow_maintainer_edit'] != null
          ? json['default_allow_maintainer_edit'] as bool
          : null,
      default_branch: json['default_branch'] != null
          ? json['default_branch'] as String
          : null,
      default_delete_branch_after_merge:
          json['default_delete_branch_after_merge'] != null
          ? json['default_delete_branch_after_merge'] as bool
          : null,
      default_merge_style: json['default_merge_style'] != null
          ? json['default_merge_style'] as String
          : null,
      description: json['description'] != null
          ? json['description'] as String
          : null,
      empty: json['empty'] != null ? json['empty'] as bool : null,
      external_tracker: json['external_tracker'] != null
          ? ExternalTracker.fromJson(
              json['external_tracker'] as Map<String, dynamic>,
            )
          : null,
      external_wiki: json['external_wiki'] != null
          ? ExternalWiki.fromJson(json['external_wiki'] as Map<String, dynamic>)
          : null,
      fork: json['fork'] != null ? json['fork'] as bool : null,
      forks_count: json['forks_count'] != null
          ? (json['forks_count'] as num).toInt()
          : null,
      full_name: json['full_name'] != null ? json['full_name'] as String : null,
      has_actions: json['has_actions'] != null
          ? json['has_actions'] as bool
          : null,
      has_code: json['has_code'] != null ? json['has_code'] as bool : null,
      has_issues: json['has_issues'] != null
          ? json['has_issues'] as bool
          : null,
      has_packages: json['has_packages'] != null
          ? json['has_packages'] as bool
          : null,
      has_projects: json['has_projects'] != null
          ? json['has_projects'] as bool
          : null,
      has_pull_requests: json['has_pull_requests'] != null
          ? json['has_pull_requests'] as bool
          : null,
      has_releases: json['has_releases'] != null
          ? json['has_releases'] as bool
          : null,
      has_wiki: json['has_wiki'] != null ? json['has_wiki'] as bool : null,
      html_url: json['html_url'] != null ? json['html_url'] as String : null,
      id: json['id'] != null ? (json['id'] as num).toInt() : null,
      ignore_whitespace_conflicts: json['ignore_whitespace_conflicts'] != null
          ? json['ignore_whitespace_conflicts'] as bool
          : null,
      internal: json['internal'] != null ? json['internal'] as bool : null,
      internal_tracker: json['internal_tracker'] != null
          ? InternalTracker.fromJson(
              json['internal_tracker'] as Map<String, dynamic>,
            )
          : null,
      language: json['language'] != null ? json['language'] as String : null,
      languages_url: json['languages_url'] != null
          ? json['languages_url'] as String
          : null,
      licenses: json['licenses'] != null
          ? (json['licenses'] as List<dynamic>).cast<String>()
          : null,
      ...
      mirror_interval: json['mirror_interval'] != null
          ...
          : null,
      mirror_updated: json['mirror_updated'] != null
          ? DateTime.parse(json['mirror_updated'] as String)
          : null,
      name: json['name'] != null ? json['name'] as String : null,
      object_format_name: json['object_format_name'] != null
          ? json['object_format_name'] as String
          : null,
      open_issues_count: json['open_issues_count'] != null
          ? (json['open_issues_count'] as num).toInt()
          : null,
      open_pr_counter: json['open_pr_counter'] != null
          ? (json['open_pr_counter'] as num).toInt()
          : null,
      ...
      projects_mode: json['projects_mode'] != null
          ? json['projects_mode'] as String
          : null,
      release_counter: json['release_counter'] != null
          ? (json['release_counter'] as num).toInt()
          : null,
      repo_transfer: json['repo_transfer'] != null
          ? RepoTransfer.fromJson(json['repo_transfer'] as Map<String, dynamic>)
          : null,
      size: json['size'] != null ? (json['size'] as num).toInt() : null,
      ssh_url: json['ssh_url'] != null ? json['ssh_url'] as String : null,
      stars_count: json['stars_count'] != null
          ? (json['stars_count'] as num).toInt()
          : null,
      ...
      watchers_count: json['watchers_count'] != null
  ...
  Map<String, dynamic> toJson() {
    ...
    if (allow_fast_forward_only_merge != null)
      map['allow_fast_forward_only_merge'] = allow_fast_forward_only_merge!;
    if (allow_manual_merge != null)
      map['allow_manual_merge'] = allow_manual_merge!;
    if (allow_merge_commits != null)
      map['allow_merge_commits'] = allow_merge_commits!;
    if (allow_rebase != null) map['allow_rebase'] = allow_rebase!;
    if (allow_rebase_explicit != null)
      map['allow_rebase_explicit'] = allow_rebase_explicit!;
    if (allow_rebase_update != null)
      map['allow_rebase_update'] = allow_rebase_update!;
    if (allow_squash_merge != null)
      map['allow_squash_merge'] = allow_squash_merge!;
    if (archived != null) map['archived'] = archived!;
    if (archived_at != null)
      map['archived_at'] = archived_at!.toIso8601String();
    if (autodetect_manual_merge != null)
      map['autodetect_manual_merge'] = autodetect_manual_merge!;
    ...
    if (default_allow_maintainer_edit != null)
      map['default_allow_maintainer_edit'] = default_allow_maintainer_edit!;
    if (default_branch != null) map['default_branch'] = default_branch!;
    if (default_delete_branch_after_merge != null)
      map['default_delete_branch_after_merge'] =
          default_delete_branch_after_merge!;
    if (default_merge_style != null)
      map['default_merge_style'] = default_merge_style!;
    if (description != null) map['description'] = description!;
    if (empty != null) map['empty'] = empty!;
    if (external_tracker != null)
      map['external_tracker'] = external_tracker!.toJson();
    ...
    if (has_pull_requests != null)
      map['has_pull_requests'] = has_pull_requests!;
    ...
    if (ignore_whitespace_conflicts != null)
      map['ignore_whitespace_conflicts'] = ignore_whitespace_conflicts!;
    if (internal != null) map['internal'] = internal!;
    if (internal_tracker != null)
      map['internal_tracker'] = internal_tracker!.toJson();
    ...
    if (mirror_updated != null)
      map['mirror_updated'] = mirror_updated!.toIso8601String();
    if (name != null) map['name'] = name!;
    if (object_format_name != null)
      map['object_format_name'] = object_format_name!;
  ...
  bool operator ==(Object other) =>
      ...
      other is Repository &&
          allow_fast_forward_only_merge ==
              other.allow_fast_forward_only_merge &&
          ...
          default_allow_maintainer_edit ==
              other.default_allow_maintainer_edit &&
          default_branch == other.default_branch &&
          default_delete_branch_after_merge ==
              other.default_delete_branch_after_merge &&
