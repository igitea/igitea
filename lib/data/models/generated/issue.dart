...
class Issue {
  ...
  bool operator ==(Object other) =>
      ...
      other is Issue &&
          ...
          user == other.user;
  @override
  int get hashCode => Object.hashAll([assets, assignee, assignees, body, closed_at, comments, created_at, due_date, html_url, id, is_locked, labels, milestone, number, original_author, original_author_id, pin_order, pull_request, ref, repository, state, time_estimate, title, updated_at, url, user]);
  @override
  String toString() => 'Issue(assets: $assets, assignee: $assignee, assignees: $assignees, body: $body, closed_at: $closed_at, comments: $comments, created_at: $created_at, due_date: $due_date, html_url: $html_url, id: $id, is_locked: $is_locked, labels: $labels, milestone: $milestone, number: $number, original_author: $original_author, original_author_id: $original_author_id, pin_order: $pin_order, pull_request: $pull_request, ref: $ref, repository: $repository, state: $state, time_estimate: $time_estimate, title: $title, updated_at: $updated_at, url: $url, user: $user)';
}
