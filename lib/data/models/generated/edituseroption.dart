...
class EditUserOption {
  ...
  factory EditUserOption.fromJson(Map<String, dynamic> json) {
    return EditUserOption(
      ...
      allow_create_organization: json['allow_create_organization'] != null ? json['allow_create_organization'] as bool : null,
      allow_git_hook: json['allow_git_hook'] != null ? json['allow_git_hook'] as bool : null,
      allow_import_local: json['allow_import_local'] != null ? json['allow_import_local'] as bool : null,
      ...
      max_repo_creation: json['max_repo_creation'] != null ? (json['max_repo_creation'] as num).toInt() : null,
      must_change_password: json['must_change_password'] != null ? json['must_change_password'] as bool : null,
  ...
  Map<String, dynamic> toJson() {
    ...
    if (allow_create_organization != null) map['allow_create_organization'] = allow_create_organization!;
    if (allow_git_hook != null) map['allow_git_hook'] = allow_git_hook!;
    if (allow_import_local != null) map['allow_import_local'] = allow_import_local!;
    if (description != null) map['description'] = description!;
    if (email != null) map['email'] = email!;
    if (full_name != null) map['full_name'] = full_name!;
    if (location != null) map['location'] = location!;
    if (login_name != null) map['login_name'] = login_name!;
    if (max_repo_creation != null) map['max_repo_creation'] = max_repo_creation!;
    if (must_change_password != null) map['must_change_password'] = must_change_password!;
  ...
  @override
  int get hashCode => Object.hash(active, admin, allow_create_organization, allow_git_hook, allow_import_local, description, email, full_name, location, login_name, max_repo_creation, must_change_password, password, prohibit_login, restricted, source_id, visibility, website);
  @override
  String toString() => 'EditUserOption(active: $active, admin: $admin, allow_create_organization: $allow_create_organization, allow_git_hook: $allow_git_hook, allow_import_local: $allow_import_local, description: $description, email: $email, full_name: $full_name, location: $location, login_name: $login_name, max_repo_creation: $max_repo_creation, must_change_password: $must_change_password, password: $password, prohibit_login: $prohibit_login, restricted: $restricted, source_id: $source_id, visibility: $visibility, website: $website)';
}
