...
class ActionTask {
  ...
  factory ActionTask.fromJson(Map<String, dynamic> json) {
    return ActionTask(
      ...
      run_number: json['run_number'] != null
          ...
          : null,
      run_started_at: json['run_started_at'] != null
  ...
  Map<String, dynamic> toJson() {
    ...
    if (run_started_at != null)
      map['run_started_at'] = run_started_at!.toIso8601String();
  ...
  @override
  String toString() =>
      'ActionTask(created_at: $created_at, display_title: $display_title, event: $event, head_branch: $head_branch, head_sha: $head_sha, id: $id, name: $name, run_number: $run_number, run_started_at: $run_started_at, status: $status, updated_at: $updated_at, url: $url, workflow_id: $workflow_id)';
}
