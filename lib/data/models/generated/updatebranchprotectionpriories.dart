...
class UpdateBranchProtectionPriories {
  final List<int>? ids;
  const UpdateBranchProtectionPriories({
    this.ids,
  });
  factory UpdateBranchProtectionPriories.fromJson(Map<String, dynamic> json) {
    return UpdateBranchProtectionPriories(
      ids: json['ids'] != null ? (json['ids'] as List<dynamic>).map((e) => (e as num).toInt()).toList() : null,
    );
  }
  ...
  bool operator ==(Object other) =>
      ...
      other is UpdateBranchProtectionPriories &&
          ids == other.ids;
  @override
