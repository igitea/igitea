...
class DeployKey {
  ...
  bool operator ==(Object other) =>
      ...
      other is DeployKey &&
          ...
          url == other.url;
  @override
  int get hashCode => Object.hash(created_at, fingerprint, id, key, key_id, read_only, repository, title, url);
  @override
  String toString() => 'DeployKey(created_at: $created_at, fingerprint: $fingerprint, id: $id, key: $key, key_id: $key_id, read_only: $read_only, repository: $repository, title: $title, url: $url)';
}
