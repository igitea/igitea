...
class PullReview {
  ...
  factory PullReview.fromJson(Map<String, dynamic> json) {
    return PullReview(
      ...
      comments_count: json['comments_count'] != null ? (json['comments_count'] as num).toInt() : null,
  ...
  Map<String, dynamic> toJson() {
    ...
    if (submitted_at != null) map['submitted_at'] = submitted_at!.toIso8601String();
  ...
  bool operator ==(Object other) =>
      ...
      other is PullReview &&
          ...
          user == other.user;
  @override
  int get hashCode => Object.hash(body, comments_count, commit_id, dismissed, html_url, id, official, pull_request_url, stale, state, submitted_at, team, updated_at, user);
  @override
  String toString() => 'PullReview(body: $body, comments_count: $comments_count, commit_id: $commit_id, dismissed: $dismissed, html_url: $html_url, id: $id, official: $official, pull_request_url: $pull_request_url, stale: $stale, state: $state, submitted_at: $submitted_at, team: $team, updated_at: $updated_at, user: $user)';
}
