...
class GeneralAttachmentSettings {
  ...
  factory GeneralAttachmentSettings.fromJson(Map<String, dynamic> json) {
    return GeneralAttachmentSettings(
      allowed_types: json['allowed_types'] != null ? json['allowed_types'] as String : null,
      enabled: json['enabled'] != null ? json['enabled'] as bool : null,
      max_files: json['max_files'] != null ? (json['max_files'] as num).toInt() : null,
      max_size: json['max_size'] != null ? (json['max_size'] as num).toInt() : null,
    );
  }
  ...
  @override
  String toString() => 'GeneralAttachmentSettings(allowed_types: $allowed_types, enabled: $enabled, max_files: $max_files, max_size: $max_size)';
}
