...
class ActionWorkflowRun {
  ...
  factory ActionWorkflowRun.fromJson(Map<String, dynamic> json) {
    return ActionWorkflowRun(
      ...
      head_repository: json['head_repository'] != null ? Repository.fromJson(json['head_repository'] as Map<String, dynamic>) : null,
      ...
      repository_id: json['repository_id'] != null ? (json['repository_id'] as num).toInt() : null,
      ...
      trigger_actor: json['trigger_actor'] != null ? User.fromJson(json['trigger_actor'] as Map<String, dynamic>) : null,
  ...
  Map<String, dynamic> toJson() {
    ...
    if (head_repository != null) map['head_repository'] = head_repository!.toJson();
