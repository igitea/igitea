...
class AnnotatedTag {
  ...
  factory AnnotatedTag.fromJson(Map<String, dynamic> json) {
    return AnnotatedTag(
      ...
      object: json['object'] != null
          ? AnnotatedTagObject.fromJson(json['object'] as Map<String, dynamic>)
          : null,
      sha: json['sha'] != null ? json['sha'] as String : null,
      tag: json['tag'] != null ? json['tag'] as String : null,
      tagger: json['tagger'] != null
          ? CommitUser.fromJson(json['tagger'] as Map<String, dynamic>)
          : null,
  ...
  @override
  int get hashCode =>
      Object.hash(message, object, sha, tag, tagger, url, verification);
  @override
  String toString() =>
      'AnnotatedTag(message: $message, object: $object, sha: $sha, tag: $tag, tagger: $tagger, url: $url, verification: $verification)';
}
