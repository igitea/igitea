...
class ActionWorkflowResponse {
  ...
  factory ActionWorkflowResponse.fromJson(Map<String, dynamic> json) {
    return ActionWorkflowResponse(
      ...
      workflows: json['workflows'] != null ? (json['workflows'] as List<dynamic>).map((e) => ActionWorkflow.fromJson(e as Map<String, dynamic>)).toList() : null,
    );
  }
  Map<String, dynamic> toJson() {
    final map = <String, dynamic>{};
    if (total_count != null) map['total_count'] = total_count!;
    if (workflows != null) map['workflows'] = workflows!.map((e) => e.toJson()).toList();
    return map;
  }
  @override
  ...
  @override
  String toString() => 'ActionWorkflowResponse(total_count: $total_count, workflows: $workflows)';
}
