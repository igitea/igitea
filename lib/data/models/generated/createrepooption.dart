...
class CreateRepoOption {
  ...
  factory CreateRepoOption.fromJson(Map<String, dynamic> json) {
    return CreateRepoOption(
      ...
      description: json['description'] != null
          ...
          : null,
      gitignores: json['gitignores'] != null
          ? json['gitignores'] as String
          : null,
      issue_labels: json['issue_labels'] != null
          ? json['issue_labels'] as String
          : null,
      ...
      trust_model: json['trust_model'] != null
          ? json['trust_model'] as String
          : null,
    );
  }
  ...
  @override
  String toString() =>
      'CreateRepoOption(auto_init: $auto_init, default_branch: $default_branch, description: $description, gitignores: $gitignores, issue_labels: $issue_labels, license: $license, name: $name, object_format_name: $object_format_name, private: $private, readme: $readme, template: $template, trust_model: $trust_model)';
}
