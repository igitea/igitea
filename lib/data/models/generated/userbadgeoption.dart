...
class UserBadgeOption {
  ...
  const UserBadgeOption({
    this.badge_slugs,
  });
  factory UserBadgeOption.fromJson(Map<String, dynamic> json) {
    return UserBadgeOption(
      badge_slugs: json['badge_slugs'] != null ? (json['badge_slugs'] as List<dynamic>).cast<String>() : null,
    );
  }
  ...
  bool operator ==(Object other) =>
      ...
      other is UserBadgeOption &&
          badge_slugs == other.badge_slugs;
  @override
