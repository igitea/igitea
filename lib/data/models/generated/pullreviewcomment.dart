...
class PullReviewComment {
  ...
  factory PullReviewComment.fromJson(Map<String, dynamic> json) {
    return PullReviewComment(
      ...
      original_commit_id: json['original_commit_id'] != null ? json['original_commit_id'] as String : null,
      original_position: json['original_position'] != null ? (json['original_position'] as num).toInt() : null,
      path: json['path'] != null ? json['path'] as String : null,
      position: json['position'] != null ? (json['position'] as num).toInt() : null,
      pull_request_review_id: json['pull_request_review_id'] != null ? (json['pull_request_review_id'] as num).toInt() : null,
      pull_request_url: json['pull_request_url'] != null ? json['pull_request_url'] as String : null,
      resolver: json['resolver'] != null ? User.fromJson(json['resolver'] as Map<String, dynamic>) : null,
  ...
  Map<String, dynamic> toJson() {
    ...
    if (original_commit_id != null) map['original_commit_id'] = original_commit_id!;
    if (original_position != null) map['original_position'] = original_position!;
    if (path != null) map['path'] = path!;
    if (position != null) map['position'] = position!;
    if (pull_request_review_id != null) map['pull_request_review_id'] = pull_request_review_id!;
