...
class MigrateRepoOptions {
  ...
  factory MigrateRepoOptions.fromJson(Map<String, dynamic> json) {
    return MigrateRepoOptions(
      auth_password: json['auth_password'] != null ? json['auth_password'] as String : null,
      auth_token: json['auth_token'] != null ? json['auth_token'] as String : null,
      auth_username: json['auth_username'] != null ? json['auth_username'] as String : null,
      aws_access_key_id: json['aws_access_key_id'] != null ? json['aws_access_key_id'] as String : null,
      aws_secret_access_key: json['aws_secret_access_key'] != null ? json['aws_secret_access_key'] as String : null,
      clone_addr: json['clone_addr'] != null ? json['clone_addr'] as String : null,
      ...
      lfs_endpoint: json['lfs_endpoint'] != null ? json['lfs_endpoint'] as String : null,
      milestones: json['milestones'] != null ? json['milestones'] as bool : null,
      ...
      repo_owner: json['repo_owner'] != null ? json['repo_owner'] as String : null,
  ...
  Map<String, dynamic> toJson() {
    ...
    if (aws_access_key_id != null) map['aws_access_key_id'] = aws_access_key_id!;
    if (aws_secret_access_key != null) map['aws_secret_access_key'] = aws_secret_access_key!;
  ...
  bool operator ==(Object other) =>
      ...
      other is MigrateRepoOptions &&
          ...
          wiki == other.wiki;
  @override
  int get hashCode => Object.hashAll([auth_password, auth_token, auth_username, aws_access_key_id, aws_secret_access_key, clone_addr, description, issues, labels, lfs, lfs_endpoint, milestones, mirror, mirror_interval, private, pull_requests, releases, repo_name, repo_owner, service, uid, wiki]);
  @override
  String toString() => 'MigrateRepoOptions(auth_password: $auth_password, auth_token: $auth_token, auth_username: $auth_username, aws_access_key_id: $aws_access_key_id, aws_secret_access_key: $aws_secret_access_key, clone_addr: $clone_addr, description: $description, issues: $issues, labels: $labels, lfs: $lfs, lfs_endpoint: $lfs_endpoint, milestones: $milestones, mirror: $mirror, mirror_interval: $mirror_interval, private: $private, pull_requests: $pull_requests, releases: $releases, repo_name: $repo_name, repo_owner: $repo_owner, service: $service, uid: $uid, wiki: $wiki)';
}
