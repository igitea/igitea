...
class CreatePullReviewOptions {
  ...
  factory CreatePullReviewOptions.fromJson(Map<String, dynamic> json) {
    return CreatePullReviewOptions(
      ...
      comments: json['comments'] != null ? (json['comments'] as List<dynamic>).map((e) => CreatePullReviewComment.fromJson(e as Map<String, dynamic>)).toList() : null,
  ...
  Map<String, dynamic> toJson() {
    ...
    if (comments != null) map['comments'] = comments!.map((e) => e.toJson()).toList();
  ...
  @override
  String toString() => 'CreatePullReviewOptions(body: $body, comments: $comments, commit_id: $commit_id, event: $event)';
}
