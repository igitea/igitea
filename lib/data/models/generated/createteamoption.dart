...
class CreateTeamOption {
  ...
  factory CreateTeamOption.fromJson(Map<String, dynamic> json) {
  ...
  @override
  int get hashCode => Object.hash(can_create_org_repo, description, includes_all_repositories, name, permission, units, units_map);
  @override
  String toString() => 'CreateTeamOption(can_create_org_repo: $can_create_org_repo, description: $description, includes_all_repositories: $includes_all_repositories, name: $name, permission: $permission, units: $units, units_map: $units_map)';
}
