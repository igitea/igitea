...
class CreateHookOption {
  ...
  factory CreateHookOption.fromJson(Map<String, dynamic> json) {
    return CreateHookOption(
      ...
      config: json['config'] != null
          ? CreateHookOptionConfig.fromJson(
  ...
  @override
  String toString() =>
      'CreateHookOption(active: $active, authorization_header: $authorization_header, branch_filter: $branch_filter, config: $config, events: $events, type: $type)';
}
