...
class EditPullRequestOption {
  ...
  @override
  String toString() =>
      'EditPullRequestOption(allow_maintainer_edit: $allow_maintainer_edit, assignee: $assignee, assignees: $assignees, base_: $base_, body: $body, due_date: $due_date, labels: $labels, milestone: $milestone, state: $state, title: $title, unset_due_date: $unset_due_date)';
}
