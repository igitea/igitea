...
class Branch {
  ...
  factory Branch.fromJson(Map<String, dynamic> json) {
    return Branch(
      commit: json['commit'] != null ? PayloadCommit.fromJson(json['commit'] as Map<String, dynamic>) : null,
      effective_branch_protection_name: json['effective_branch_protection_name'] != null ? json['effective_branch_protection_name'] as String : null,
      ...
      user_can_merge: json['user_can_merge'] != null ? json['user_can_merge'] as bool : null,
      user_can_push: json['user_can_push'] != null ? json['user_can_push'] as bool : null,
    );
  }
  Map<String, dynamic> toJson() {
    final map = <String, dynamic>{};
    if (commit != null) map['commit'] = commit!.toJson();
    if (effective_branch_protection_name != null) map['effective_branch_protection_name'] = effective_branch_protection_name!;
  ...
  bool operator ==(Object other) =>
      ...
      other is Branch &&
          commit == other.commit &&
          effective_branch_protection_name == other.effective_branch_protection_name &&
  ...
  @override
  int get hashCode => Object.hash(commit, effective_branch_protection_name, enable_status_check, name, protected, required_approvals, status_check_contexts, user_can_merge, user_can_push);
  @override
  String toString() => 'Branch(commit: $commit, effective_branch_protection_name: $effective_branch_protection_name, enable_status_check: $enable_status_check, name: $name, protected: $protected, required_approvals: $required_approvals, status_check_contexts: $status_check_contexts, user_can_merge: $user_can_merge, user_can_push: $user_can_push)';
}
